  ...
  return (
    ...
    <div className="h-[60%] ">
      <div className="bg-cover h-full w-full"
        ...
        <div className="relative top-24 mx-12 grid grid-cols-2 gap-52">
            <div className="">
                <h1 className="text-5xl font-bold font-serif py-9">Your gateway to unlimited entertainment</h1>
            ...
            <div>
            <div className="relative flex flex-row space-x-4 top-52 justify-center items-center">
