  ...
  return (
    <div className="h-[340px]">
      ...
      >
        ...
        {/* top side */}
        <div className="flex flex-row relative top-7 justify-between items-center mx-10 w-full">
        ...
        <div className="relative top-10 mx-12 grid grid-cols-2 gap-52">
          <div>
            <h1 className="text-5xl font-bold font-serif py-8">Your gateway to unlimited entertainment</h1>
          ...
          <div>
            <div className="relative flex flex-row space-x-4 justify-center top-56 items-center">
